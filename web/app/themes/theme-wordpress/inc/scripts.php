...
add_action('wp_enqueue_scripts', function () {
    ...
    if (isViteHMRAvailable()) {
        ...
        wp_enqueue_script_module($ts_handle, getViteDevServerAddress().'/assets/js/app.js', $dependencies, $version);
        wp_enqueue_script_module($vite_handle, getViteDevServerAddress().'/@vite/client', $dependencies, $version);
